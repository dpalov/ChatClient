...
/** Code should be thread safe. see Threaded Java if needed. */
...
public class ChatServer {
    ...
    public static void main(String[] argv) throws IOException {
        ...
        System.out.println("**ERROR* ChatServer 0.1 quiting");
    }
    ...
    protected class ChatHandler extends Thread {
        ...
        /** String from a user's handle (name) */
        ...
        /*
         *  Each ChatHandler is a Thread so here's the run() method which
        ...
        public void run() {
            ...
            try {
                ...
                while ((line = is.readLine()) != null) {
                    ...
                    switch (c) {
                        case ChatProtocol.CMD_LOGIN:
                            ...
                            login = line;
                            broadcast(CHATMASTER_ID, login + " join us for a total of " +
                                    clients.size() + " users");
                            break;
                        case ChatProtocol.CMD_MESG:
                            if (login == null) {
                                send(CHATMASTER_ID, "Plese login first");
                                continue;
                            }
                ...
                // the sock ended so we're done. Bye!
                System.out.println(login + SEP + "All Done");
                String message = "This should never appear.";
                synchronized (clients) {
                    clients.remove(this);
                    if (clients.size() == 0) {
                        System.out.println(CHATMASTER_ID + SEP + "All alone now");
                    } else if (clients.size() == 1) {
                        message = "You're talking to yourself";
                    } else {
        ...
        protected void broadcast(String sender, String mesg) {
